/**
 * Builtin connector-sablonok szinkronizálása a kódból a DB-be (displayName, descriptor, activationHelp).
 * Futtatás: cd app && npx tsx scripts/sync-builtin-templates.ts --production
 */
