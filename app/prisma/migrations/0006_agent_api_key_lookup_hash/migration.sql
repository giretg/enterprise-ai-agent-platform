...
-- jelentett. Ez az oszlop a nyers kulcs szerveroldali sóval képzett HKDF-SHA-256
-- kereső-lenyomatát tárolja, amin
-- egyedi index van, így a hitelesítés O(1) megkereséssel megtalálja a pontos kulcssort.
-- A nyugalmi titok továbbra is a `key_hash` (bcrypt) — a HKDF csak keresésre szolgál.
--
