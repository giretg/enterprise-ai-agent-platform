  ...
  return (
    <Card title="Feladatkör-korlátozás">
      <p className="mb-4 text-xs text-ink-faint">
        Ha az agent egyetlen jól körülhatárolt célt szolgál, itt leegyszerűsítheted a
        felületét: eltűnik a chat, és egyetlen gomb marad, ami egy előre kiválasztott
        skillhez kötött feladatot indít — szabad szöveges feladatleírás nélkül.
      </p>
      ...
      <div className="mt-3 rounded-lg border border-honey/40 bg-honey/10 px-3 py-2 text-xs text-ink-soft">
        <p className="font-medium text-honey">Ez a felületet egyszerűsíti, nem a jogokat szűkíti.</p>
        <p className="mt-1">
