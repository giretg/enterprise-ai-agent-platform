...
export default async function ControlPlaneNotFound() {
  ...
  return (
    <div className="flex min-h-[40vh] items-center justify-center px-6">
      <div className="w-full max-w-md rounded-2xl border border-line bg-card p-8 text-center shadow-sm">
        ...
        <h2 className="mt-2 font-display text-2xl font-semibold text-ink">{t('cpNotFoundTitle')}</h2>
        <p className="mt-3 text-sm text-ink-soft">{t('cpNotFoundBody')}</p>
        <Link
          href="/control-plane"
