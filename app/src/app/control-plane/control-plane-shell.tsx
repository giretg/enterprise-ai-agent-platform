...
import { isAgentWorkspacePath } from '@/lib/agent-workspace-routes'
...
/**
 * Stabil layout-wrapper: iframe-ben (board-modál) soha ne mountolódjon a
 * teljes shell + agent-sáv — a ticket-kattintás különben belerakná az egész
 * alkalmazást a modálba.
 */
...
function ControlPlaneBody({
  ...
  const isAgentRoute = isAgentWorkspacePath(pathname)
        ...
        <AppShell
          ...
          headerExtra={
            <div className="flex items-center gap-2">
              ...
              <ControlPlaneHeaderExtras />
            </div>
          }
        >
          <ControlPlaneBody canCreateAgent={canCreateAgent} canCreateTicket={canCreateTicket}>
            {children}
          </ControlPlaneBody>
        </AppShell>
      </Suspense>
