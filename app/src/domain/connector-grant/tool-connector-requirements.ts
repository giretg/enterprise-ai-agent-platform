...
>> = {
  ...
  gmail_get_thread: { connectorType: 'gmail', accessMode: 'read' },
  gmail_list_labels: { connectorType: 'gmail', accessMode: 'read' },
  gmail_list_drafts: { connectorType: 'gmail', accessMode: 'read' },
  gmail_create_draft: { connectorType: 'gmail', accessMode: 'write' },
  gmail_send: { connectorType: 'gmail', accessMode: 'write' },
  gmail_modify_labels: { connectorType: 'gmail', accessMode: 'write' },
  gmail_trash: { connectorType: 'gmail', accessMode: 'write' },
