/**
 * Sensitivity span collector — EXTRACT from the legacy model-gateway router.
 *
 * The rest of the classifier/redactor lived in domain/gateway and is DELETE.
 * KEEP privacy transforms only need match spans + the deterministic patterns
 * they are built from.
 */
