 ...
 * Cache-találati arány = sum(cachedPromptTokens) / sum(promptTokens) csak a
 * nem-`null` sorokra, azonos modell felé menő hívásokon. Ha egyetlen
 * modellcsoport sem éri el a `minCacheCalls` küszöböt, nincs minta.
 */
