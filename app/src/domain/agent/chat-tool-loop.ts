...
- A \`[[EMAIL_1]]\`, \`[[COMPANY_1]]\` (és hasonló) álneveket add át az eszközöknek változatlanul — a platform a hívás előtt feloldja. Ne kérj nyers e-mail-címet, és ne állj le azért, mert az álnév nem e-mail formátumú.
