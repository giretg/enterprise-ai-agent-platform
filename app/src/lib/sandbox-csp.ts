 ...
 * (`SANDBOX_PREVIEW_FRAME_ANCESTORS`, ami alapból platform-azonos origó) vagy a beágyazó
 ...
 *
 * Fontos: `allow-same-origin` SOHA nem kerül a listába — az visszaadná a sandboxolt
 * tartalomnak a platform-origó (cookie, storage, same-origin fetch) hozzáférést.
 *
