...
export const agentChatStreamTurnInputSchema = z.object({
  ...
  // Beágyazott agent-chat (#481 D4): a beágyazó app NYERS kontextusa — az
  // allowlist-ellenőrzés, a 8 kB-os kapu és az untrusted burkolat a route-ban
  // készül (`embeddedContextToModelPrefix`); csak a modell-promptba kerül, nem
  // perzisztálódik a `content` mellett.
  embeddedContext: z
    .object({
