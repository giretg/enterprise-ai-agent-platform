...
| **F2-D — Gmail MCP-tool-ok** | `gmail.search/get_message/create_draft/send`; human-kapu a küldésre | F2-C |
...
- **D-PUC-1 — Token-vault:** saját Secret Manager-alapú vault (F2-B) vs. korai adopt (connected-accounts réteg). Javaslat: saját az első 1-2 providerre, adopt-újraértékelés a 3.-nál. Dönti: S7.
- **D-PUC-2 — Gmail MCP-szerver forrása:** kész nyílt MCP Gmail-szerver a Broker mögött vs. saját thin MCP-adapter a Gmail REST API-ra. Javaslat: a Broker mögött bármelyik mehet, mert a kontroll a brokerben van; az MVP elv szerint a legszűkebb működő.
