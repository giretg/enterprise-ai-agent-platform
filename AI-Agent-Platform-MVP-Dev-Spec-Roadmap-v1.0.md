...
| Build / lint állapot | Kész | `npm run lint`, `npm run build` és `npm run test:acceptance` zöld az `app/` könyvtárban (acceptance: **89 sikeres**, 2 kihagyva opcionális docker E2E, 0 sikertelen — 2026-06-16 session 14). |
