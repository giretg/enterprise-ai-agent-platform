...
- [ ] A fenti listák alapból limitáltak; teljes dump csak explicit admin/export úton.
- [ ] UI nem törik el üres / egyoldalas / többoldalas adaton.
- [ ] Nagy tenant fixture-rel (pl. 1k+ sor) a lista p95 elfogadható marad.
