...
- **Minimális minta-méret és őszinte üresség.** A kártya futás-szinten detektál, de csak akkor jelenít meg mintát, ha az agentnek az ablakban legalább **3 elemezhető futása** van, és a minta ezek közül legalább **kettőben** megjelenik. Ez alól **a cache-prefix törés a kivétel**: a prompt-cache a stabil előtag agent-szintű tulajdonsága, nem egy futásé, és egy tipikus futásban 2–4 modellhívás van — futás-szintű kapuval a „legalább 10 nem-`null` hívás" küszöb sosem teljesülne, vagyis a leggyakoribb valós eset (rövid futások, elromlott prefix) kimutathatatlan maradna. Ezért ez az egy detektor az ablak összes nem-`null` hívására dől el, és a minta-méret kaput maga a hívás-szám küszöb adja. Ez alatt a kártya „nincs elég adat a megbízható elemzéshez" állapotot mutat — a #230-ban is kimondott elv szerint: inkább nincs állítás, mint gyenge állítás.
